...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"public/components/diagnosis.component.js":[function(require,module,exports) {
/***********************************************
 *
 *
 *
...
window.addEventListener("DOMContentLoaded", function (_) {
  var form = document.querySelector(".stroke--diagnosis--form");
  var time = document.querySelectorAll(".system--date"); ///Update The Date of the System
