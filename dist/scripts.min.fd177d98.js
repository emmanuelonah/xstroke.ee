...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/purgecss/node_modules/postcss/docs/api/assets/scripts.min.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "SyYu": [function (require, module, exports) {
    ...
    !function (e, t) {
      ...
      "function" == typeof A && A.amd ? A([], t) : "object" == _typeof(module) && module.exports ? module.exports = t() : (e.AnchorJS = t(), e.anchors = new e.AnchorJS());
    }(this, function () {
      "use strict";
      ...
      return function (A) {
        ...
        this.options = A || {}, this.elements = [], e(this.options), this.isTouchDevice = function () {
          ...
          for (function () {
            ...
            if (this.hasAnchorJSLink(i[a])) w.push(a);else {
  ...
  "SFxP": [function (require, module, exports) {
    ...
    document.getElementById("filter-input").addEventListener("keyup", function (e) {
      var t, s, i;
      if (13 === e.keyCode) for (t = 0; t < n.length; t++) {
        if (!(s = n[t]).classList.contains("display-none")) return location.replace(s.firstChild.href), e.preventDefault();
      }
      ...
      for (o.match(/^\s*$/) || (a = function a(e) {
        var t = e.firstChild.innerHTML || e.textContent;
        return t && -1 !== t.toLowerCase().indexOf(o);
      }), t = 0; t < n.length; t++) {
        s = n[t], i = Array.from(s.getElementsByTagName("a")), a(s) || i.some(a) ? s.classList.remove("display-none") : s.classList.add("display-none");
      }
    });

    for (var s = document.getElementsByClassName("toggle-sibling"), i = 0; i < s.length; i++) {
    ...
    for (var d = document.getElementsByClassName("pre-open"), c = 0; c < d.length; c++) {
